...
# Performance optimization: significantly increase concurrency and rate limit
export FACTBASE_CONCURRENCY=${FACTBASE_CONCURRENCY:-64}
export FACTBASE_RPS=${FACTBASE_RPS:-20.0}
